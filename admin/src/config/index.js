...
const config = {
  ...
  production: {
    API_BASE_URL:
      import.meta.env.VITE_API_BASE_URL || "https://api-domain.com",
    CLIENT_BASE_URL:
      import.meta.env.VITE_CLIENT_BASE_URL || "https://client-domain.com",
    ADMIN_BASE_URL:
      import.meta.env.VITE_ADMIN_BASE_URL || "https://admin-domain.com",
    NODE_ENV: "production",
    DEBUG: false,
    LOG_LEVEL: "error",
  },
