          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Founded in 2019, Ateliê Urso Bebê began with a simple mission:
        ...
        <Container>
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-8">
              Join thousands of satisfied customers and discover why Ateliê Urso Bebê is the preferred choice for online shopping.
            </p>
