...
const Cart = () => {
  ...
  const products = useSelector((state) => state.atelieReducer.products);
  const userInfo = useSelector((state) => state.atelieReducer.userInfo);
  const orderCount = useSelector((state) => state.atelieReducer.orderCount);
