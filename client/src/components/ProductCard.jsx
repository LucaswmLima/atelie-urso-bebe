...
const ProductCard = ({ item, viewMode = "grid", className = "" }) => {
  ...
  return (
    <div
      className={`w-full relative group bg-white border p-5 rounded-xl border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300 ease-out ${className}`}
